...
4. How to survive? Player has 3 functional buttons that will keep Itadori alive and player surviving the game AND WIN! YAY. 
    - FOOD -- using the food button will increase the health of Itadori by 2 and decrease his hunger by 1.
    - TRAIN -- using the train button will increase the health of Itadori by 1 and also increase his hunger by 2.
